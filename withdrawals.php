          ...
          <div class="">
            ...
            <div class="clearfix"></div>
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Withdrawal Details Table <small>Users</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a href="make-request.php" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i> Request For Withdrawals</a>
                      </li>
