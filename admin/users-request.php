          ...
          <div class="">
            ...
            <div class="clearfix"></div>
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Request Table <small>Users</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <!-- <li><a href="add_employees.php" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i> Add Employee</a>
                      </li> -->
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>28/04/2019</td>
                          <td>
                            <a href="view-request.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                            <a href="update-request.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
